...
Comprobante electrónico **clase E**, obligatorio para **toda exportación de servicios** (criterio = **aprovechamiento económico en el exterior**, no nacionalidad del cliente), independiente del canal de cobro (Wise/Payoneer/Deel/SWIFT). Requiere punto de venta **exclusivo de exportación** y clave fiscal **nivel 3**. **IVA 0%.** Los cobros con Factura E **NO computan** al tope a efectos de *categorizar* — pero (lectura conservadora de ARCA) **el total facturado no puede exceder el tope de cat K**. Marco: RG 2758/10 + RG 4401/19 (base) + RG 5616/2024 (moneda extranjera/TC). Fuente: ARCA, exportación de servicios.
